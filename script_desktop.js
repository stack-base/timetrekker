...
function showAdminBanner(uid) {
    ...
    D.querySelector('main').style.paddingTop = '0px'; // Layout handles flex automatically but visual tweak might be needed
    // We adjust the body height to fit
